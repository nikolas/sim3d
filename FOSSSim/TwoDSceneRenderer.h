...
private:
  ...
  void renderSolidCircle( const Eigen::Vector3d& center, double radius ) const;
  void renderCircle( const Eigen::Vector3d& center, double radius ) const;

  void renderSweptEdge( const Eigen::Vector3d& x0, const Eigen::Vector3d& x1, double radius ) const;
